...
const ProductListPage = () => {
  return (
    <div className="flex w-full flex-col gap-6">
      <section className="relative overflow-hidden border-y-2 border-zinc-900 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="absolute right-0 top-0 hidden h-full w-1/3 lg:block">
          <img 
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZXATB1pzh0KScW5G-6BXiKejoPfIfy2sEuQ&s" 
            alt="Campus Essentials" 
            className="h-full w-full object-cover opacity-20"
          />
          <div className="absolute inset-0 bg-gradient-to-l from-transparent to-zinc-50" />
        </div>
